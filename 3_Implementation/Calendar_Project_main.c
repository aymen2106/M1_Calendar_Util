...
void gotoxy (int x, int y)//This func allows you to print text in any place of screen.//
{
...
int getDayNumber(int day,int mon,int year){ //will retun day number
    ...
    while(1){
        ...
        switch(choice){
            case 1://Find the day which you want to search//
                ...
                getch();
                break;
            case 2 ://Will print all the days of a month//
